...
#include "../../../../NewGControl/src/MainWindow.h"
...
template <> constexpr inline auto MainWindow::qt_create_metaobjectdata<qt_meta_tag_ZN10MainWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'RequestGrblSettings'
        QtMocHelpers::SlotData<void()>(39, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'RequestGrblParameters'
        QtMocHelpers::SlotData<void()>(40, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'RequestGrblParserState'
        QtMocHelpers::SlotData<void()>(41, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'RequestGrblBuildInfo'
        QtMocHelpers::SlotData<void()>(42, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'RequestGrblStartupBlocks'
        QtMocHelpers::SlotData<void()>(43, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'OpenGrblSettingsManager'
        QtMocHelpers::SlotData<void()>(44, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'ExportGrblSnapshot'
        QtMocHelpers::SlotData<void()>(45, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'ImportGrblSnapshot'
...
void MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 35: _t->RequestGrblSettings(); break;
        case 36: _t->RequestGrblParameters(); break;
        case 37: _t->RequestGrblParserState(); break;
        case 38: _t->RequestGrblBuildInfo(); break;
        case 39: _t->RequestGrblStartupBlocks(); break;
        case 40: _t->OpenGrblSettingsManager(); break;
        case 41: _t->ExportGrblSnapshot(); break;
        case 42: _t->ImportGrblSnapshot(); break;
        default: ;
        }
    }
}
