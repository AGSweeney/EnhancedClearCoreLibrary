...
private slots:
    ...
    void RequestGrblParameters();
    void RequestGrblParserState();
    void RequestGrblBuildInfo();
    void RequestGrblStartupBlocks();
    void OpenGrblSettingsManager();
    void ExportGrblSnapshot();
    void ImportGrblSnapshot();
...
private:
    ...
    void SendRealtimeBytes(const QByteArray &bytes);
    void HandlePossibleGrblLine(const QString &line);
    void ShowVariantStatus();
    ...
    /// Local profile flag for single-axis bench testing presets.
    ...
    std::unique_ptr<GrblProtocol> m_protocol;
    std::unique_ptr<ProgramRunner> m_programRunner;
    QMap<int, double> m_grblSettings;
    QStringList m_grblParameters;
    QString m_grblParserState;
    QString m_grblBuildInfo;
    QStringList m_grblStartupBlocks;
};
