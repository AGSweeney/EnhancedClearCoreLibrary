...
void MainWindow::BuildUi() {
    ...
    setStyleSheet(
        ...
        "QDoubleSpinBox::up-arrow { image: none; border-left: 4px solid transparent; border-right: 4px solid transparent; border-bottom: 5px solid #bfc7d2; width: 0px; height: 0px; }"
        "QDoubleSpinBox::down-arrow { image: none; border-left: 4px solid transparent; border-right: 4px solid transparent; border-top: 5px solid #bfc7d2; width: 0px; height: 0px; }"
